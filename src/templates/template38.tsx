...
export default function Template38({ editableData }: TemplateProps) {
  ...
  const ContactView = () => (
    <Section id="contact" bgType="secondary" className="animate-in zoom-in-95 duration-500">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          <div className="p-8 sm:p-12 shadow-2xl bg-white/5 backdrop-blur-md" style={{ borderRadius: `${theme.borderRadius}px`, border: `1px solid ${theme.textColor}10`, backgroundColor: theme.backgroundColor }}>
            ...
            <div className="space-y-5">
              <input className="w-full p-4 bg-transparent border outline-none font-medium" style={{ borderColor: `${theme.textColor}20`, borderRadius: `${theme.borderRadius}px` }} placeholder="Your Name (Optional)" />
              <input className="w-full p-4 bg-transparent border outline-none font-medium" style={{ borderColor: `${theme.textColor}20`, borderRadius: `${theme.borderRadius}px` }} placeholder="Email Address" />
              <textarea className="w-full p-4 bg-transparent border outline-none font-medium min-h-[150px] resize-none" style={{ borderColor: `${theme.textColor}20`, borderRadius: `${theme.borderRadius}px` }} placeholder="Provide details about the story..."></textarea>
              <button className="w-full py-4 font-black uppercase tracking-widest text-sm transition-opacity hover:opacity-90" style={{ backgroundColor: theme.primaryColor, color: "#fff", borderRadius: `${theme.borderRadius}px` }}>
                <EditableText regionKey="contact.submit" fallback="Submit Securely" />
              </button>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-10 lg:pl-8">
            <div className="space-y-2 border-b pb-8" style={{ borderColor: `${theme.textColor}15` }}>
              ...
              <EditableText regionKey="contact.address" fallback="1 Media Plaza, Suite 400, New York, NY 10001" className="font-bold text-xl block" />
            </div>
            <div className="space-y-2 border-b pb-8" style={{ borderColor: `${theme.textColor}15` }}>
              <h4 className="text-xs font-black uppercase opacity-50 tracking-widest">Editorial Inquiries</h4>
              <EditableText regionKey="contact.email.ed" fallback="editor@dailychronicle.news" className="font-bold text-xl block" />
            </div>
            <div className="space-y-2 border-b pb-8" style={{ borderColor: `${theme.textColor}15` }}>
              <h4 className="text-xs font-black uppercase opacity-50 tracking-widest">Press & Partnerships</h4>
              <EditableText regionKey="contact.email.press" fallback="press@dailychronicle.news" className="font-bold text-xl block" />
            </div>
            <div className="space-y-2">
              <h4 className="text-xs font-black uppercase opacity-50 tracking-widest">General Phone</h4>
              <EditableText regionKey="contact.phone" fallback="+1 (555) 000-1111" className="font-bold text-xl block" />
            </div>
          </div>
        </div>
      </div>
