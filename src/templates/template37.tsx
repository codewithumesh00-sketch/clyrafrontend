...
export default function Template37({ editableData }: TemplateProps) {
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-6 pt-8">
            <div className="flex items-center gap-4">
              ...
              <div>
                <span className="block text-xs font-bold uppercase tracking-widest opacity-50">Email Me</span>
                <EditableText regionKey="contact.email" fallback="hello@alexcarter.design" className="font-bold text-lg block" />
              </div>
            </div>
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-full flex items-center justify-center shadow-inner" style={{ backgroundColor: theme.backgroundColor }}>
              ...
              <div>
                <span className="block text-xs font-bold uppercase tracking-widest opacity-50">Location</span>
                <EditableText regionKey="contact.location" fallback="San Francisco, CA (Remote)" className="font-bold text-lg block" />
              </div>
            </div>
          </div>
        </div>

        <div className="p-8 md:p-12 shadow-2xl border" style={{ backgroundColor: theme.backgroundColor, borderRadius: `${theme.borderRadius * 1.5}px`, borderColor: `${theme.textColor}0A` }}>
          <div className="space-y-6">
            <div>
              <label className="block text-sm font-bold mb-2 opacity-80">Your Name</label>
              <input className="w-full p-4 bg-transparent border-2 outline-none transition-colors focus:border-indigo-500" style={{ borderColor: `${theme.textColor}15`, borderRadius: `${theme.borderRadius}px` }} placeholder="John Doe" />
            </div>
            <div>
              <label className="block text-sm font-bold mb-2 opacity-80">Email Address</label>
              <input className="w-full p-4 bg-transparent border-2 outline-none transition-colors focus:border-indigo-500" style={{ borderColor: `${theme.textColor}15`, borderRadius: `${theme.borderRadius}px` }} placeholder="john@example.com" />
            </div>
            <div>
              <label className="block text-sm font-bold mb-2 opacity-80">Project Details</label>
              <textarea className="w-full p-4 bg-transparent border-2 outline-none transition-colors focus:border-indigo-500 min-h-[150px] resize-none" style={{ borderColor: `${theme.textColor}15`, borderRadius: `${theme.borderRadius}px` }} placeholder="Tell me about your vision..."></textarea>
            </div>
            <button className="w-full py-5 font-black uppercase tracking-widest text-sm shadow-lg hover:shadow-xl transition-all active:scale-95 mt-4" style={{ backgroundColor: theme.primaryColor, color: "#fff", borderRadius: `9999px` }}>
